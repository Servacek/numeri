...
bool readDate(uint8_t& day, uint8_t& month); // nacita len datum (den, mesiac)
bool readTime(uint8_t& hour, uint8_t& minute); // nacita len cas (hodina, minuta)
bool adjust(const DateTime& dt); // zapise cas (rok 2000-2099)
// vrati teplotu v stupnoch Celsia, zaokruhlenu na cele cisla.
